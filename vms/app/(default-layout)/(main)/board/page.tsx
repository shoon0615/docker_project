...
import * as o from "@/app/(default-layout)/(main)/board/temp/Options"
import List from "@/app/(default-layout)/(main)/board/components/BoardList"
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
      ...
      <div className="mb-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-8 gap-y-4 mb-4">
              {/* Row 1 (Visual) */}
              <div>
                <Label
              ...
              <div className="flex items-center lg:col-span-2">
                ...
                <Label
                  ...
                  className="ml-2 block text-sm text-gray-900 leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                >
                  청소년도 참여 가능해요.
                </Label>
              </div>
